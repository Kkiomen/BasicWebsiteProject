<div>
    <div>
        ...
        >
            <div
                class="absolute inset-0 z-20 bg-gradient-to-r from-[rgb(61,175,251,0.9)] to-[#1839d6] bg-cover bg-center bg-no-repeat"
            ></div>

            <div
                class="container relative z-30 pt-10 pb-12  sm:pb-48 lg:pt-64 lg:pb-48"
            >
                <div class="flex flex-col items-center justify-center lg:flex-row">
                    ...
                    <div class="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
                        ...
                        <p class="text-center sm:text-left text-white text-lg">
...
{{--                        </div>--}}
                        <div class="flex flex-row justify-center gap-2 mt-1">
                            <a href="{{ route('blog') }}" class="bg-white text-black px-3 py-1 w-full">
                                Blog
                            </a>
