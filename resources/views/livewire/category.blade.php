<div>
    ...
    <div class="container px-8 mx-auto xl:px-5 max-w-screen-lg pb-5 lg:py-8">
                        ...
                        <div>
                            <div class="flex gap-1">
                                <a href="{{ route('category', ['category_slug' => $article->category->slug]) }}">
                                    <span
                                        class="inline-block text-xs font-medium tracking-wider uppercase mt-5 text-blue-600">{{ $article->category->name }}</span>
                                </a>
                            </div>
                            ...
                            <div class="mt-2 flex items-center space-x-3 text-gray-500 dark:text-gray-400">
                                ...
                                <time class="truncate text-sm"
                                      datetime="2022-10-21T15:48:00.000Z">{{ date('Y-m-d' , strtotime($article->created_at)) }}
                                </time>
                            </div>
                        </div>
                    </div>
